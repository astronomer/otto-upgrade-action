...
Symmetric to otto-review-action's extract-verdict.py. Under
``--persona upgrader`` the persona's bundled output schema registers a synthetic
...
Expected result shape (the `upgrader` persona's output schema):
  {
